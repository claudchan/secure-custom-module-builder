                ...
                [
                    ...
                    'sub_fields' => [
                        ...
                        [
                            ...
                            'instructions' => __('Enter sub-field names, one per line. Format: field_name|Field Label|field_type. Use true_false for boolean toggle fields. Add |required to make a sub-field required. Indent lines below a repeater sub-field to create nested repeater fields. For select fields, add choices as value:Label pairs. Add |allow_null to allow an empty selection. For nested repeaters, add |max=4 to limit rows.', 'secure-custom-module-builder'),
                            'placeholder' => "item_title|Item Title|text|required\nitem_content|Item Content|textarea\nshow_button|Show Button|true_false\nitem_tags|Tags|repeater|max=4\n  tag_label|Tag Label|text|required\n  tag_url|Tag URL|url\nbutton_style|Button Style|select|primary:Primary,ghost:Ghost\nbutton_target|Button Target|select|same:Same Tab,new:New Tab|allow_null",
                            'rows' => 4,
                            'conditional_logic' => [
                                [
                                    [
