        ...
        acf_add_local_field_group([
            ...
            'fields' => [
                ...
                [
                    ...
                    'label' => __('Preview Thumbnail', 'scmb'),
                    'name' => 'module_preview_image',
                    'type' => 'image',
                    'instructions' => __('Shown in the block inserter preview. Uploads are stored in the WordPress Media Library.', 'scmb'),
                    'return_format' => 'id',
                    'preview_size' => 'medium',
                    'library' => 'all',
                ],
                ...
                [
                    ...
                    'label' => __('Single Instance', 'scmb'),
                    'name' => 'module_single_instance',
                    'type' => 'true_false',
                    'instructions' => __('Uses WordPress core block support to allow this block only once per page or post.', 'scmb'),
                    'message' => __('Allow only one instance per page/post', 'scmb'),
                    'default_value' => 0,
                    'ui' => 1,
                ],
                [
